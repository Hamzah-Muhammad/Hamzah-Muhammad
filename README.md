...
| [**OpenCodingAgent**](https://github.com/Hamzah-Muhammad/OpenCodingAgent) | A free coding agent for your terminal — reads/writes/edits files, runs shell commands, and uses git, running entirely on a free LLM API (NVIDIA's DeepSeek V4) instead of a paid key. |
